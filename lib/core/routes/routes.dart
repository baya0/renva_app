...
enum Pages {
  ...
  GetPage get page => switch (this) {
    ...
    // Profile routes
    edit_profile => GetPage(name: value, page: () => EditProfilePage()),

    // Provider routes
    join_as_provider => GetPage(name: value, page: () => JoinAsProviderPage()),
    join_as_provider_form => GetPage(name: value, page: () => JoinAsProviderFormPage()),
    provider_home => GetPage(name: value, page: () => ProviderHomePage()),
    view_order_detail => GetPage(name: value, page: () => ViewOrderDetail()),
    add_offer_page => GetPage(name: value, page: () => AddOfferPage()),
    review_offer_page => GetPage(name: value, page: () => ReviewOfferPage()),
    provider_orders_page => GetPage(name: value, page: () => ProviderOrdersPage()),
    //adding order process :D
    add_order_page => GetPage(name: value, page: () => AddOrdersPage()),
    add_order_subcategory => GetPage(name: value, page: () => AddSubOrderPage()),
    add_order_details => GetPage(name: value, page: () => AddOrderDetailsPage()),
    complete_order_detail => GetPage(name: value, page: () => CompleteOrderPage()),
    review_completed_order_page => GetPage(name: value, page: () => ReviewCompletedOrderPage()),
  };
}
